    ...
    <el-container>
        ...
        <el-form ref="form" :inline="true" :model="form" label-width="80px">
          <el-form-item :label="$t('flow.timerange')">
            ...
            >
              ...
              <el-option :label="$t('paycount.yesterday')" value="yesterday" />
      ...
      <el-main v-if="show">
        ...
        >
          ...
          <el-table-column prop="totalAmount" :label="$t('pix.valor')" />
        </el-table>
      </el-main>
    </el-container>
  </div>
...
import { getPayShopTotal } from '@/api/pay'
...
export default {
  ...
  methods: {
    ...
    getTotalList() {
      ...
      getPayShopTotal(query).then((res) => {
        this.show = true
        this.tableData = res.data.data
        this.totalamount = res.data.grandTotalAmount
